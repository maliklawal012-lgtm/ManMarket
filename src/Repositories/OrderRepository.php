...
final class OrderRepository
{
    ...
    public function create(array $data): int
    {
        $stmt = $this->db->prepare('
            INSERT INTO orders (customer_user_id, customer_name, customer_email, customer_phone, delivery_location, subtotal_amount, total_amount, currency, payment_choice)
            VALUES (:customer_user_id, :customer_name, :customer_email, :customer_phone, :delivery_location, :subtotal_amount, :total_amount, :currency, :payment_choice)
        ');
        $stmt->execute([
