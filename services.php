...
$services = [
    ...
    ['icon' => 'check-circle', 'title' => 'Produits locaux garantis', 'text' => 'Des commerçants vérifiés de Man et des produits de qualité.'],
    ['icon' => 'refresh', 'title' => 'Retours faciles', 'text' => 'Un produit ne convient pas ? Retournez-le simplement auprès du commerçant.'],
...
$faq = [
    ...
    ['q' => 'Comment devenir commerçant partenaire ?', 'a' => 'Cliquez sur "Devenir vendeur" ci-dessus et créez votre compte commerçant pour commencer à vendre vos produits sur ManMarket.'],
...
<section class="container services-page">
    ...
    <div class="card banner-delivery merchant-banner">
        <div class="banner-text">
            <h2>Vous êtes commerçant à Man ?</h2>
